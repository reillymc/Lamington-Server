...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`recipe_rating` (
  ...
  CONSTRAINT `fk-meal_rating-meal_id`
    FOREIGN KEY (`recipeId`)
    REFERENCES `lamingtondb`.`recipe` (`recipeId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk-meal_rating-rater_id`
    FOREIGN KEY (`raterId`)
    REFERENCES `lamingtondb`.`user` (`userId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`tag` (
  ...
  CONSTRAINT `fk_tag_1`
    ...
    REFERENCES `lamingtondb`.`tag` (`tagId`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`recipe_tag` (
  ...
  CONSTRAINT `fk-meal_category-meal_id`
    FOREIGN KEY (`recipeId`)
    REFERENCES `lamingtondb`.`recipe` (`recipeId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk-meal_category-category_id`
    FOREIGN KEY (`tagId`)
    REFERENCES `lamingtondb`.`tag` (`tagId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`ingredient` (
  ...
  CONSTRAINT `fk_ingredient_createdBy`
    FOREIGN KEY (`createdBy`)
    REFERENCES `lamingtondb`.`user` (`userId`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`recipe_section` (
  ...
  CONSTRAINT `fk-meal_section-meal_id`
    FOREIGN KEY (`recipeId`)
    REFERENCES `lamingtondb`.`recipe` (`recipeId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`recipe_ingredient` (
  ...
  CONSTRAINT `fk-meal_ingredient-meal_id`
    FOREIGN KEY (`recipeId`)
    REFERENCES `lamingtondb`.`recipe` (`recipeId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk-meal_ingredient-ingredient_id`
    FOREIGN KEY (`ingredientId`)
    REFERENCES `lamingtondb`.`ingredient` (`ingredientId`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT `fk_meal_ingredient-meal_section`
    FOREIGN KEY (`sectionId`)
    REFERENCES `lamingtondb`.`recipe_section` (`sectionId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_meal_ingredient_recipe_id`
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`recipe_step` (
  ...
  CONSTRAINT `fk-meal_step-meal_id`
    FOREIGN KEY (`recipeId`)
    REFERENCES `lamingtondb`.`recipe` (`recipeId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_meal_step-section_id`
    FOREIGN KEY (`sectionId`)
    REFERENCES `lamingtondb`.`recipe_section` (`sectionId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`list_item` (
  ...
  CONSTRAINT `fk_list_item_list_id`
    FOREIGN KEY (`listId`)
    REFERENCES `lamingtondb`.`list` (`listId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_list_item_ingredient_id`
    FOREIGN KEY (`ingredientId`)
    REFERENCES `lamingtondb`.`ingredient` (`ingredientId`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT `fk_list_item_1`
    FOREIGN KEY (`createdBy`)
    REFERENCES `lamingtondb`.`user` (`userId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`list_member` (
  ...
  CONSTRAINT `fk_list_member_userId`
    FOREIGN KEY (`userId`)
    REFERENCES `lamingtondb`.`user` (`userId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_list_member_listId`
    FOREIGN KEY (`listId`)
    REFERENCES `lamingtondb`.`list` (`listId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`book` (
  ...
  CONSTRAINT `fk_book_createdBy_user`
    FOREIGN KEY (`createdBy`)
    REFERENCES `lamingtondb`.`user` (`userId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`book_recipe` (
  ...
  CONSTRAINT `fk_book_meal_1`
    FOREIGN KEY (`bookId`)
    REFERENCES `lamingtondb`.`book` (`bookId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_book_meal_2`
    FOREIGN KEY (`recipeId`)
    REFERENCES `lamingtondb`.`recipe` (`recipeId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`book_member` (
  ...
  INDEX `fk_list_member_userId_idx` (`userId` ASC),
  CONSTRAINT `fk_book_member_userId`
    FOREIGN KEY (`userId`)
    REFERENCES `lamingtondb`.`user` (`userId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`planner` (
  ...
  CONSTRAINT `fk_planner_createdBy_user`
    FOREIGN KEY (`createdBy`)
    REFERENCES `lamingtondb`.`user` (`userId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`planner_meal` (
  ...
  CONSTRAINT `fk_planner_meal_1`
    FOREIGN KEY (`plannerId`)
    REFERENCES `lamingtondb`.`planner` (`plannerId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_planner_meal_2`
    FOREIGN KEY (`createdBy`)
    REFERENCES `lamingtondb`.`user` (`userId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_planner_meal_3`
    FOREIGN KEY (`recipeId`)
    REFERENCES `lamingtondb`.`recipe` (`recipeId`)
    ON DELETE SET NULL
    ON UPDATE SET NULL)
...
CREATE TABLE IF NOT EXISTS `lamingtondb`.`planner_member` (
  ...
  CONSTRAINT `fk_planner_member_planner`
    FOREIGN KEY (`plannerId`)
    REFERENCES `lamingtondb`.`planner` (`plannerId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_planner_member_user`
    FOREIGN KEY (`userId`)
    REFERENCES `lamingtondb`.`user` (`userId`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
